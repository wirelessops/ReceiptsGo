...
public class DriveStreamsManagerTest {
    ...
    public void uploadFileToDriveWithSyncState() throws Exception {
        ...
        when(driveStreamMappings.postInsertSyncState(driveFile)).thenReturn(newSyncState);
    ...
    public void updateDriveFileWithSyncState() throws Exception {
        ...
        when(driveStreamMappings.postUpdateSyncState(driveFile)).thenReturn(newSyncState);
