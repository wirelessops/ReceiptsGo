...
public class CompatPdfPDImageXFactory implements PdfPDImageXFactory {
    ...
    public void open() throws IOException, SecurityException {
        ...
        pdfRenderer = new PdfRendererCompat(context, parcelFileDescriptor);
    }
    ...
    public PDImageXObject get() throws IOException {
        ...
        PdfRendererCompat.Page page = null;
        Bitmap bitmap = null;
        try {
            ...
            page.render(bitmap, destClip, null, PdfRendererCompat.Page.RENDER_MODE_FOR_DISPLAY);
