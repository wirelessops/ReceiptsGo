 ...
 */
class ReceiptExtra2Column(id: Int, syncState: SyncState, customOrderId: Long, uuid: UUID) :
    ...
    override fun getValue(rowItem: Receipt): String = rowItem.extraEditText2.orEmpty()
}
