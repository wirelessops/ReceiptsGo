...
public enum InAppPurchase {
    ...
    SmartReceiptsPlus(Subscription.class, "plus_sku_5", new HashSet<>(Arrays.asList("pro_sku_3", "plus_sku_4")), new HashSet<>(Arrays.asList(PurchaseFamily.SmartReceiptsPlus, PurchaseFamily.Ocr))),
