...
import co.smartreceipts.android.ExtraInitializerBasicReceiptsImpl;
...
public class FlavorModule {
    ...
    @Provides
    @ApplicationScope
    public static ExtraInitializer provideExtraInitializer(ExtraInitializerBasicReceiptsImpl plusInitializer) {
