...
import static com.wops.receiptsgo.persistence.database.tables.AbstractSqlTable.COLUMN_ID;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_COMMENT;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_COMMENT_HIDDEN_AUTO_COMPLETE;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_COSTCENTER_HIDDEN_AUTO_COMPLETE;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_COST_CENTER;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_DEFAULT_CURRENCY;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_DRIVE_IS_SYNCED;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_DRIVE_MARKED_FOR_DELETION;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_DRIVE_SYNC_ID;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_FILTERS;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_FROM;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_FROM_TIMEZONE;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_LAST_LOCAL_MODIFICATION_TIME;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_NAME;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_NAME_HIDDEN_AUTO_COMPLETE;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_PROCESSING_STATUS;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_TO;
import static com.wops.receiptsgo.persistence.database.tables.TripsTable.COLUMN_TO_TIMEZONE;
