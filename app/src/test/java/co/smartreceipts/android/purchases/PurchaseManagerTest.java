...
public class PurchaseManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        when(remoteSubscriptionManager.getNewRemoteSubscriptions()).thenReturn(Observable.empty());
    ...
    public void onCreate() {
        ...
        verify(purchaseWallet).getActiveLocalInAppPurchases();
    }
    ...
    public void initializeWithNewRemoteSubscriptions() throws Exception {
        RemoteSubscription mockSubscription = mock(RemoteSubscription.class);
        when(mockSubscription.getInAppPurchase()).thenReturn(InAppPurchase.SmartReceiptsPlus);
        when(remoteSubscriptionManager.getNewRemoteSubscriptions()).thenReturn(Observable.just(Collections.singleton(mockSubscription)));
    ...
    public void getAvailableSubscriptionsWithNoneAvailable() throws Exception {
        ...
        purchaseManager.getAvailableSubscriptions().test()
                ...
                .assertComplete()
                .assertNoErrors();
        verify(purchaseWallet, never()).addLocalInAppPurchaseToWallet(any(ManagedProduct.class));
        verify(purchaseWallet, never()).updateLocalInAppPurchasesInWallet(anySetOf(ManagedProduct.class));
        assertEquals(bundleCaptor.getValue().getStringArrayList("ITEM_ID_LIST"), InAppPurchase.getSubscriptionSkus());
    }
