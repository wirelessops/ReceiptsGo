...
public class ImmutableLegacyNetPriceImplTest {
    ...
    ImmutableLegacyNetPriceImpl sameCurrencyPrice;
    ImmutableLegacyNetPriceImpl differentCurrenciesNoExchangeRatePrice;
    ImmutableLegacyNetPriceImpl differentCurrenciesWithExchangeRatePrice;
    ...
    public void setUp() throws Exception {
        ...
        sameCurrencyPrice = new ImmutableLegacyNetPriceImpl(Arrays.asList(usd1, usd2));
        differentCurrenciesNoExchangeRatePrice = new ImmutableLegacyNetPriceImpl(Arrays.asList(eur1, usd2));
        differentCurrenciesWithExchangeRatePrice = new ImmutableLegacyNetPriceImpl(Arrays.asList(eurToUsd1, usd2));
    }
    ...
    public void getCurrencyFormattedPrice() {
        ...
        assertEquals("EUR1.00; $2.00", differentCurrenciesWithExchangeRatePrice.getCurrencyFormattedPrice());
    }
    ...
    public void getCurrencyCodeFormattedPrice() throws Exception {
        ...
        assertEquals("EUR1.00; USD2.00", differentCurrenciesWithExchangeRatePrice.getCurrencyCodeFormattedPrice());
    }

    @Test
    public void getCurrency() {
        assertEquals(USD_CURRENCY, sameCurrencyPrice.getCurrency());
        assertEquals(PriceCurrency.MIXED_CURRENCY, differentCurrenciesNoExchangeRatePrice.getCurrency());
        assertEquals(PriceCurrency.MIXED_CURRENCY, differentCurrenciesWithExchangeRatePrice.getCurrency());
    }

    @Test
    public void getCurrencyCode() {
        assertEquals(USD_CURRENCY.getCurrencyCode(), sameCurrencyPrice.getCurrencyCode());
        assertEquals(PriceCurrency.MIXED_CURRENCY.getCurrencyCode(), differentCurrenciesNoExchangeRatePrice.getCurrencyCode());
        assertEquals(PriceCurrency.MIXED_CURRENCY.getCurrencyCode(), differentCurrenciesWithExchangeRatePrice.getCurrencyCode());
    }
    ...
    public void parcel() throws Exception {
        ...
        final ImmutableLegacyNetPriceImpl parcelPrice1 = ImmutableLegacyNetPriceImpl.CREATOR.createFromParcel(parcel1);
        ...
        final ImmutableLegacyNetPriceImpl parcelPrice2 = ImmutableLegacyNetPriceImpl.CREATOR.createFromParcel(parcel2);
        ...
        final ImmutableLegacyNetPriceImpl parcelPrice3 = ImmutableLegacyNetPriceImpl.CREATOR.createFromParcel(parcel3);
